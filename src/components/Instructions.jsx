function Instructions({ onStart }) {
  return (
    <div className="card p-6 mx-auto" style={{ maxWidth: '600px' }}>
      <h1 className="title has-text-centered">Private Quiz Experience</h1>
      <div className="content">
        ...
        <ul>
          ...
          <li>All responses are stored temporarily in your browser's session storage</li>
          <li>Data is automatically cleared when you close your browser</li>
        </ul>
        <p>The quiz consists of 10 statements. For each one, choose whether you think it's:</p>
        <ul>
          <li>True</li>
          <li>False</li>
          <li>Maybe</li>
